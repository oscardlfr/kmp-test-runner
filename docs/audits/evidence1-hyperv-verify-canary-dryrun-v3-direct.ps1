...
param(
    ...
    [string]$ReportPath = 'C:\kmp-eval\scratch\hyperv-verify-canary-dryrun-v3-direct\HYPERV-VERIFY-CANARY-DRYRUN-V3-DIRECT.json'
)

$ErrorActionPreference = 'Stop'
$ProgressPreference = 'SilentlyContinue'
$result = [ordered]@{
    schema = 1; operation = 'dry-v3'; state = 'failed'; failure_code = 'module_import_failed'; stage = 'bootstrap'
...
try {
    ...
    $root = 'C:\kmp-eval\scratch\hyperv-verify-canary-dryrun-v3-direct\'
...
try {
    ...
    $result = Invoke-E1ValidationDirect -Operation 'dry-v3' @parameters
} catch { }
