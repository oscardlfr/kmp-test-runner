...
- npm: `kmp-test-runner@0.10.1` (Trusted Publisher OIDC; auto-publishes on push to `main`)
- Gradle plugin: `io.github.oscardlfr.kmp-test-runner:0.10.1` (GitHub Packages; auto-publishes on push to `main`)
- GitHub Releases: `v0.10.1` (linux.tar.gz + windows.zip; auto-tagged from `package.json` version on push to `main`)
