...
- npm: `kmp-test-runner@0.11.0` (Trusted Publisher OIDC; auto-publishes on push to `main`)
- Gradle plugin: `io.github.oscardlfr.kmp-test-runner:0.11.0` (GitHub Packages; auto-publishes on push to `main`)
- GitHub Releases: `v0.11.0` (linux.tar.gz + windows.zip; auto-tagged from `package.json` version on push to `main`)
