...
// / 0 cascade / 0 RED-orchestrator). dipatternsdemo + AGP-instrumented
...
//   node tools/wide-smoke-pass-10.mjs --only TaskFlow,gyg          # subset re-run
...
function emitMarkdown(results, outputPath) {
  ...
  // exactly). Pass-10 must match these counts (or improve on dipatternsdemo
