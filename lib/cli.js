...
Options:
  ...
  --variant <value>          Android variant: auto (default; respects
...
Options:
  ...
  --variant <value>          Android variant for instrumented benchmarks:
...
function peekIsolatedFlags(args) {
  ...
  for (let i = 0; i < args.length; i++) {
    ...
    else if (args[i] === '--isolated-no-lock') noLock = true;
