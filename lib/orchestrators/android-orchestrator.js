...
export async function runAndroid({
  ...
  // collected validation errors. Mirrors the parallel / changed / benchmark
  // gates; placed before resolveIsolatedDir so no cache dir is created.
  const invalidArgs = isolatedFlags.errors.filter(e => e.code && e.code.startsWith('invalid_'));
