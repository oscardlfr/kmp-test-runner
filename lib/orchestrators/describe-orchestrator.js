...
// (Drift #5 below). The set mirrors `CLI_GLOBAL_FLAGS` in
...
//      modules (v0.9 step 9.4 — Bug #4 — a private project's `:core-foo`
...
export function runDescribe({
  ...
  // v0.9 session 2 Bug-C — compile the --module-filter regex eagerly so
  ...
  // Regex compilation moved to runDescribe top (Bug-C) — already validated.
