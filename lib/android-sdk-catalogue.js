...
export function inspectLocalProperties(projectRoot) {
  ...
  // dropped). This means `C\:\Users\me\AppData\Local\Android\Sdk` becomes
  // `C:UsersmeAppDataLocalAndroidSdk` — an invalid path. Detect by
...
// 2026-05-09 on a private KMP project wet-audit (local.properties had
