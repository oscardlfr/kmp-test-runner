...
export function maybeAugmentEnvWithAndroidSdk(projectRoot, env, log = () => {}) {
  // Already-set ANDROID_HOME wins (user explicitly chose) — don't override.
  ...
  // (1) Project-supplied sdk.dir via local.properties.
  ...
  // (2) Canonical-install-paths auto-discovery.
  if (!sdkPath) {
