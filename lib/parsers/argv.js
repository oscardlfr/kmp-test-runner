...
// v0.10 #1 — strip `--color <mode>` and `--color=<mode>` from args; return
// cleaned args + parsed mode (or null when absent). Validation happens here
// so cli.js can surface an invalid_args envelope before any orchestrator
