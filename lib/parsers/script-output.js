...
//
// Refactor PR-09: extracted from lib/cli.js. cli.js re-exports through the
// `export {}` block at the bottom (live bindings) so existing consumers
// (cli.test.js, Pester Json-Envelope-Contract.Tests.ps1) keep importing from
// './cli.js' unchanged.
