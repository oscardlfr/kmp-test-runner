...
// v0.9 session 2 Bug-B — enum allowlist for `--platform`. Mirrors the
// PowerShell wrapper's `[ValidateSet('android','jvm','all')]` and the
// `kmp-test benchmark --help` documentation.
const PLATFORM_VALUES = ['android', 'jvm', 'all'];
