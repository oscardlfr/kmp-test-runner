...
// lib/project/cache.js — project-model cache layer (PR-08 refactor pre-v0.10).
//
...
//
// PR-08 (2026-05-10): the introspector is now 3 files (project-model.js,
// project/analyze-module.js, project/cache.js). Hash all three so any source
// change still triggers invalidation. Fingerprint VALUE changes once at the
// PR-08 merge (intentional: caches regenerate on next run).
