...
// canonical-task resolution (PR-08 refactor pre-v0.10).
//
...
// task name extraction). Extracted from lib/project-model.js so the
// orchestrator (buildProjectModel) stays a thin composition step.
//
