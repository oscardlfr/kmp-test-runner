...
async function main() {
  ...
  // v0.10 #3 — switched to loadMergedConfig so orchestrators see the union of
  ...
  // 2026-05-04 (fix-PR-C) — ANDROID_HOME auto-injection for ANY AGP-applying
  ...
  try {
    ...
    if (sig.agpVersion !== null) {
      ...
      if (augmented !== process.env) {
        ...
        // wet-audit-v0.9-release fix — propagate PATH so adb (and other
