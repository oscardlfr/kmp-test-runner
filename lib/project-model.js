...
//
// PR-08 (refactor pre-v0.10): the introspector is split across 3 files —
// this orchestrator (buildProjectModel + parseGradleTasksOutput +
// detectBuildLogicCoverageHints), ./project/analyze-module.js (per-module
// classifier + canonical-task resolution), and ./project/cache.js (schema
// versioning, fingerprint, content-addressed cache key, gradle-task probe
// with disk persistence). External consumers keep importing every public
// symbol from this file via ESM live-binding re-exports.
...
// + module-analysis surface from this module (PR-08 refactor pre-v0.10).
export {
  SCHEMA_VERSION,
  MODEL_FINGERPRINT,
  CACHE_DIR_NAME,
...
export { analyzeModule, resolveTasksFor } from './project/analyze-module.js';
