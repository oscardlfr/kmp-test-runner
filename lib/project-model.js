...
// Bumped 3 → 4 (2026-05-03): analyzeModule now emits namedJvmTargets +
// intermediateGroups; resolveTasksFor uses these to override JVM-family
// task prediction. Old caches don't have these fields and would fall
// through to the wrong code path. Bump invalidates.
...
export function analyzeModule(projectRoot, moduleName, buildLogicHints = null, catalog = null, buildLogicDescriptors = null) {
  ...
  return { type, androidDsl, hasFlavor, sourceSets, coveragePlugin, namedJvmTargets, intermediateGroups };
}
