...
export function analyzeModule(projectRoot, moduleName, buildLogicHints = null, catalog = null) {
...
export function buildProjectModel(projectRoot, opts = {}) {
  ...
  for (const inc of settingsIncludes) {
    const analysis = analyzeModule(projectRoot, inc, buildLogicHints, catalog);
