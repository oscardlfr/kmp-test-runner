...
// Bumped 2 → 3 (2026-05-03): parseSettingsIncludes now strips Kotlin
// comments before parsing. Old caches contain phantom modules from
// `// include(":foo")` lines that were treated as live. Bump invalidates.
