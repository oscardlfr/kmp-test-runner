...
//
// Thin shim around dispatchScriptCommand. Benchmark's adaptive outer-timeout
// (smoke=2100s / main=3600s / stress=5400s) is keyed on `sub === 'benchmark'`
// inside dispatchScriptCommand — passing the sub here ensures that branch
// fires.
