...
//
// Pure dispatch shim around runDescribe({...}). The orchestrator at
// lib/describe-orchestrator.js owns the actual logic; invalid-regex
// `--module-filter` validation happens INSIDE runDescribe (see
// describe-orchestrator.js:217-230), so parse() here is a pass-through.
